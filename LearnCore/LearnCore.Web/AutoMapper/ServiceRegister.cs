...
namespace LearnCore.Web.AutoMapper
{
    public static class ServiceRegister
    {
        ...
        public static IServiceCollection RegisterAssembly(this IServiceCollection service, string interfaceAssemblyName)
        {
            ...
            var assembly = AutoMapperHelper.GetAssembly(interfaceAssemblyName);
            if (assembly == null)
            {
            ...
            foreach (var type in types)
            {
                ...
                var implementType = AutoMapperHelper.GetImplementType(implementTypeName, type);
        ...
        public static IServiceCollection RegisterAssembly(this IServiceCollection service, string interfaceAssemblyName, string implementAssemblyName)
        {
            ...
            var interfaceAssembly = AutoMapperHelper.GetAssembly(interfaceAssemblyName);
            if (interfaceAssembly == null)
            {
                throw new DllNotFoundException($"the dll \"{interfaceAssemblyName}\" not be found");
            }

            var implementAssembly = AutoMapperHelper.GetAssembly(implementAssemblyName);
